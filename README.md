...
디자이너도 개발자도 마케터도 없이 혼자 일하는 사람을 위한 AI 에이전트 스킬 15개.

제품 영상 만들기, 전자책 PDF 뽑기, 블로그 글쓰기, 회의록 정리, 고객 카톡, 댓글 답글.
전부 제가 커뮤니티 6기를 운영하면서 매일 하던 일이고, 지금은 에이전트가 합니다.
...
그 과정에서 깨진 것들을 스킬로 정리한 게 이 저장소입니다.
