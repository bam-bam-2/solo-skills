...
> - **블로그 스킬은 3개로 쪼겜습니다** — 정보성 글에 후기 톤을 쓰면 검색에서 밀리고, 후기에 정보성 구조를 쓰면 사람이 안 읽습니다
...
> 원래 블로그 스킬이 하나였는데 셋으로 쪼겜습니다. 글 종류마다 제목·분량·톤의 기준이 서로 충돌해서, 하나에 다 넣으니 어느 쪽으로도 안 맞는 글이 나왔습니다.
