...
- **한국 번역학계 번역투 연구** — 8대 번역투 유형이 분류 체계의 뼈대다.
  이영옥(2001) 「무생물 주어 타동사구문의 영한번역」 번역학연구 2(1): 53-76 을 비롯해
  윤미선·김택민·임진주·홍승연(2018), 이상빈(2017·2018a·2018b), 마승혜(2018), 김혜림(2022), 김혜영(2019) 등.
...
학자 이름·연도·저널·페이지는 [`references/scholarship.md`](references/scholarship.md)에
원문 그대로 보존돼 있다. 자체 추정이나 확장 없이 옮겼다.

**내가 더한 부분**은 이것뿐이다 — 한국어 실무에서 반복적으로 지적받은 표현
(`~가 아니라` 대조 구문, `여정`, `굴러가다`, 방어적 안심 문장 등)을 금지어로 추가하고,
윤문 강도를 Fast/Strict로 나눠 실제 원고에 돌 수 있게 절차화한 것.
